...
#         self.regressor = DecisionTreeRegressor(max_depth=5, min_samples_split=2)
...
#         self.assertLess(mse, 10, "MSE слишком велик; модель требует улучшения.")
...
class TestDecisionTreeClassifier(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.classifier = DecisionTreeClassifier(max_depth=5, min_samples_split=10, probabilities=True)
